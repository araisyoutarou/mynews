                ...
                <div class="login-body card-body">
                    <from method="POST" action="{{ route('login') }}">
                        ...
                        <div class="from-group row">
                            <label for="email" class="col-sm-4 col-from-label text-md-right">{{ __('messages.E-Mail Address') }}</label>
                            
                            <div class="col-md-6">
                                <input id="email" type="email" class="from-control{{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" value="{{ old('email') }}" required autofocus>
                        ...
                        <div class="from-group row">
                            <label for="password" class="col-md-4 col-from-label text-md-right">{{ __('messages.Password') }}</label>
